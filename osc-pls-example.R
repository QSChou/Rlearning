...
#GitHub
#New gist @QSChou
#  @dgrapovdgrapov/Orthogonal Signal Correction (OSC) for PLS models OSC-PLS (OPLS)
#Last active 13 days ago
#Embed  
#<script src="https://gist.github.com/dgrapov/5166570.js"></script>
#  Download ZIP
# Code  Revisions 9  Stars 6  Forks 4
#Orthogonal Signal Correction for PLS models (OPLS)
#Raw  Orthogonal Signal Correction (OSC) for PLS models OSC-PLS (OPLS)
...
setwd("d:/userdata/R/script/edc/OPLS/sampledata")
data <- read.csv("glycan.csv",header = TRUE)
...
#Y (object to predict)
pls.y<-as.numeric(as.character(unlist(pls.data$Disease_Status..Y.))) # Disease_Status
